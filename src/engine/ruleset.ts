...
export const VICTORY_MODE_DESCRIPTIONS: Record<VictoryMode, string> = {
  conquest:
    "Win PvP battles against distinct rivals: 2 players need 1, 3 need 2, 4 need 2, 5 need 3. Eliminated rivals also count, once each; defeating then eliminating the same rival never counts twice. Flagging an enemy Town earns you a resource-gain " +
  ...
  grail:
    ...
    "movement point, then carry it home to your town), or meet the Conquest requirement through PvP wins and eliminated rivals " +
  ...
  "dragon-hunt":
    "Win either way: defeat the Dragon Utopia (no need to hold it afterwards), or meet the Conquest requirement through PvP wins and eliminated rivals " +
  ...
  "dragon-conqueror":
    ...
    "besiege it (Walls, Gate, Arrow Tower) to take it. Control the Utopia at the start of your turn to win, or meet the Conquest requirement through PvP wins and eliminated rivals."
};
