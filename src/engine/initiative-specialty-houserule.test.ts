...
const INITIATIVE_SPECIALTY_IDS = [
  ...
  "specialty.clancy.4",
  "specialty.creyle.6",
  // Dhuin VI and every Eikthurn level now use bespoke non-Initiative effects;
  // they are covered in bulwark-heroes.test.ts instead of this shared-helper sweep.
