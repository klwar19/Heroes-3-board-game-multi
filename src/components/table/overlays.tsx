...
function SpellBookSaveTile({
  ...
  const standing = cardLibrary[action.cardId]
    ? standingSpellPower(state, viewerPlayerId, cardLibrary[action.cardId]) +
      committedSchoolExpertPower(state.reactionWindow, viewerPlayerId, cardLibrary[action.cardId])
    : 0;
  const chosenValues = [
  ...
  const powerPaidBy = (selection: TraySelection) => {
    ...
    const standing = card
      ? standingSpellPower(state, viewerPlayerId, card) +
        committedSchoolExpertPower(state.reactionWindow, viewerPlayerId, card)
      : 0;
