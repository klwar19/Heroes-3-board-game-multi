...
export function HexMapBoard({
  ...
  for (const tile of sortedTiles) {
    ...
    if (tile.faceDown) {
      ...
      // underground pool likewise ships its Ⅴ–Ⅵ and Ⅵ–Ⅶ bands behind one
      // underground back — so the face-down hint shows the whole range and the
      // exact band stays secret until the tile is revealed.
      const backLabelDisplay =
        tile.group === "sea" ? "Ⅳ–Ⅶ" : tile.group === "subterranean" ? "Ⅴ–Ⅶ" : tile.backLabel ?? "";
