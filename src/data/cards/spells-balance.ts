...
export const polishBalanceSpellCards: CardLibrary = {
  ...
  // Berserk — the top Power-4 rung reaches Azure and tierless Creature-Bank
  // units as requested. Lower rungs keep the printed bronze/silver gates.
  "spell.berserk": reprint("spell.berserk", {
    tags: tags(
      "spell.berserk",
      "Activation: select a unit. In its activation it must attack the nearest unit, or move to it and attack: Power 0: bronze; Power 2: bronze or silver; Power 4: any unit, including Azure and Creature-Bank units.",
    ),
    effect: {
      type: "BERSERK",
  ...
  "spell.counterstrike": reprint("spell.counterstrike", {
    ...
    effect: {
      ...
      gradeByPower: { 0: "bronze", 1: "silver", 3: "gold" },
    },
  }),
...
export const POLISH_BALANCE_SPELL_IDS: readonly string[] = Object.keys(
