...
export const imperiumUnitDefinitions: Record<string, UnitDefinition> = {
  "imperium.astra_militarum": {
    ...
    few: { attack: 2, defense: 0, health: 2, initiative: 4, cost: { gold: 2 }, abilities: ["imperium-vox-fire-mission-few"], abilityText: "[activation] Vox Fire Mission — once per round, mark an enemy within 2 spaces; the next friendly attack against it gains +1 Attack.", cardImage: unitCard("bronze", "astra-militarum", "few") },
    pack: { attack: 2, defense: 0, health: 3, initiative: 6, cost: { gold: 3 }, abilities: ["imperium-vox-fire-mission-pack"], abilityText: "[activation] Veteran Vox Net — once per round, mark an enemy within 3 spaces; the next friendly attack against it gains +1 Attack.", cardImage: unitCard("bronze", "astra-militarum", "pack") },
    source
  },
  "imperium.apothecary": {
  ...
  "imperium.rhino": {
    ...
    few: { attack: 3, defense: 1, health: 5, initiative: 9, cost: { gold: 6 }, abilities: ["imperium-rhino-transport"], abilityText: "[movement] Armoured Transport — when this unit moves, it may carry one adjacent friendly unit and place it in an empty space adjacent to where this unit lands.", cardImage: unitCard("silver", "rhino", "few") },
    pack: { attack: 3, defense: 1, health: 8, initiative: 13, cost: { gold: 12 }, abilities: ["imperium-rhino-transport"], abilityText: "[movement] Armoured Transport — when this unit moves, it may carry one adjacent friendly unit and place it in an empty space adjacent to where this unit lands.", cardImage: unitCard("silver", "rhino", "pack") },
    source
  },
  ...
  "imperium.dreadnought": {
    ...
    few: { attack: 5, defense: 1, health: 7, initiative: 6, cost: { gold: 13 }, type: "ground", abilities: ["imperium-duty-eternal-few", "imperium-dreadnought-first-round-armour"], abilityText: "[unit_passive] Duty Eternal — once per Combat, reduce one damage assignment to this unit by 1. First-Round Armour — reduce damage from every attack against this unit by 1 during the first Combat round.", cardImage: unitCard("golden", "dreadnought", "few") },
  ...
  "imperium.titan": {
    ...
    pack: { attack: 7, defense: 3, health: 9, initiative: 6, cost: { gold: 29, valuables: 2 }, abilities: ["imperium-god-engine-sweep-pack"], abilityText: "2 [valuables] [unit_attack] Exalted God-Engine — after attacking, strike every adjacent enemy with 4 Attack.", cardImage: unitCard("golden", "titan", "pack") },
    source
  }
};
