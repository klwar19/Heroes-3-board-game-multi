...
export const unitAbilities: Record<string, UnitAbilityDefinition> = {
  ...
  "forge-vet-cyberbrute-odd-guard": { id: "forge-vet-cyberbrute-odd-guard", name: "Odd Round Guard", text: "+1 Defense when attacked during odd-numbered combat rounds.", effect: { type: "FORGE_VETERANCY", mechanic: "cyberbrute-odd-guard" }, implementationStatus: "implemented" },
