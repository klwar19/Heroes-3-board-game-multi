...
export const unitAbilities: Record<string, UnitAbilityDefinition> = {
  "ctv-muscle-reversal": { id: "ctv-muscle-reversal", name: "Muscle Reversal", text: "Once per round, after surviving an adjacent enemy's attack with a resolved -1 or 0 Attack die, deal 1 damage to a chosen adjacent enemy.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "muscle-reversal" }, implementationStatus: "implemented" },
  "ctv-returning-edge": { id: "ctv-returning-edge", name: "Returning Edge", text: "Once per round, after this unit retaliates with a resolved 0 or +1 Attack die, deal 1 damage to a different chosen adjacent enemy.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "returning-edge" }, implementationStatus: "implemented" },
  "ctv-covering-extraction": { id: "ctv-covering-extraction", name: "Covering Extraction", text: "Once per round, after this unit damages an enemy with its own non-adjacent ranged attack, move another chosen ally 1 space. This movement does not trigger movement abilities.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "covering-extraction" }, implementationStatus: "implemented" },
  "ctv-meridian-exchange": { id: "ctv-meridian-exchange", name: "Meridian Exchange", text: "Once per round, after this unit's own attack damages a surviving enemy with a resolved 0 Attack die, that enemy suffers -1 Attack on its next attack and a chosen adjacent ally heals 1 damage.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "meridian-exchange" }, implementationStatus: "implemented" },
  "ctv-rule-unravel": { id: "ctv-rule-unravel", name: "Rule Unravel", text: "Once per round, after this unit's own attack damages a surviving enemy with a positive removable ongoing effect, remove its oldest such effect and heal this unit 1 damage. Does not require an Attack die.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "rule-unravel" }, implementationStatus: "implemented" },
  "ctv-field-repair": { id: "ctv-field-repair", name: "Field Recovery", text: "Once per round, when this unit activates with no adjacent enemy, heal 1 damage from a chosen adjacent ally. Does not end the activation.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "field-repair" }, implementationStatus: "implemented" },
  "ntv-victory-command": { id: "ntv-victory-command", name: "Victorious Advance", text: "Once per round, after defeating an enemy unit, gain +1 Attack for the next attack and optionally move another ally 1 space without triggering movement abilities. The Attack bonus does not stack and expires at combat end.", effect: { type: "NEUTRAL_TOWN_VETERANCY", mechanic: "victory-command" }, implementationStatus: "implemented" },
  "ntv-ally-blind-instinct": { id: "ntv-ally-blind-instinct", name: "Shared Adversity", text: "Ignore penalties caused by enemy ongoing effects. Gain +1 Attack while any living allied unit, including this unit, is affected by a negative ongoing effect. Multiple affected allies do not increase the bonus.", effect: { type: "NEUTRAL_TOWN_VETERANCY", mechanic: "ally-blind-instinct" }, implementationStatus: "implemented" },
  "ntv-water-air-damper": { id: "ntv-water-air-damper", name: "Storm Dampening", text: "Enemy Water and Air School Spells have -1 Power. A spell belonging to both schools loses only 1 Power from this unit.", effect: { type: "NEUTRAL_TOWN_VETERANCY", mechanic: "water-air-damper" }, implementationStatus: "implemented" },
  ...
  "ctv-blood-price": { id: "ctv-blood-price", name: "Blood Price", text: "Once per combat, after this unit's own attack rolls a resolved -1 against a surviving enemy, you may pay 1 HP to deal that enemy 2 effect damage. Requires at least 2 remaining HP; the HP cost cannot be reduced.", effect: { type: "CUSTOM_TOWN_VETERANCY", mechanic: "blood-price" }, implementationStatus: "implemented" },
  ...
  "forge-vet-cyberbrute-mend": { id: "forge-vet-cyberbrute-mend", name: "Reactive Repair", text: "Once per combat round, when damaged by a spell or specialty, heal 1 HP.", effect: { type: "FORGE_VETERANCY", mechanic: "cyberbrute-mend" }, implementationStatus: "implemented" },
  "forge-vet-zombie-full-rebirth": { id: "forge-vet-zombie-full-rebirth", name: "Full Rebirth", text: "Once per combat, when this unit reaches 0 HP, restore it to full HP on its current side (including Pack) and give it +1 Attack for the rest of combat.", effect: { type: "FORGE_VETERANCY", mechanic: "zombie-full-rebirth" }, implementationStatus: "implemented" },
  "forge-vet-watcher-ground-air-guard": { id: "forge-vet-watcher-ground-air-guard", name: "Ground and Air Guard", text: "+1 Defense against attacks by ground and flying units.", effect: { type: "FORGE_VETERANCY", mechanic: "watcher-ground-air-guard" }, implementationStatus: "implemented" },
  "forge-vet-bruiser-die-reward": { id: "forge-vet-bruiser-die-reward", name: "Combat Salvage", text: "On this unit's Attack die: -1 or +1 heals 1 HP; 0 draws 1 card, up to 2 cards per combat.", effect: { type: "FORGE_VETERANCY", mechanic: "bruiser-die-reward" }, implementationStatus: "implemented" },
  "forge-vet-cyberbrute-odd-guard": { id: "forge-vet-cyberbrute-odd-guard", name: "Odd Round Guard", text: "Enemies attacking this unit roll at disadvantage during odd-numbered combat rounds.", effect: { type: "FORGE_VETERANCY", mechanic: "cyberbrute-odd-guard" }, implementationStatus: "implemented" },
  "forge-vet-cyberbrute-shock": { id: "forge-vet-cyberbrute-shock", name: "Damage Shock", text: "When this unit takes more than 3 damage from one attack, deal 1 damage to an adjacent enemy (choose if several are adjacent).", effect: { type: "FORGE_VETERANCY", mechanic: "cyberbrute-shock" }, implementationStatus: "implemented" },
  "forge-vet-tank-ground-air-guard": { id: "forge-vet-tank-ground-air-guard", name: "Ground and Air Armor", text: "+1 Defense against attacks by flying and ground units.", effect: { type: "FORGE_VETERANCY", mechanic: "tank-ground-air-guard" }, implementationStatus: "implemented" },
  "forge-vet-jump-round-die": { id: "forge-vet-jump-round-die", name: "Combat Calibration", text: "At the start of each combat round, roll an Attack die: 0 heals this unit 1 HP; -1 lets you choose one enemy to lose 1 Defense for this round; +1 lets you choose one ally to gain 6 Initiative for this round.", effect: { type: "FORGE_VETERANCY", mechanic: "jump-round-die" }, implementationStatus: "implemented" },
  ...
  "forge-vet-tank-reposition": { id: "forge-vet-tank-reposition", name: "Counterdrive", text: "After retaliating, this unit may move up to 2 spaces without passing through other units.", effect: { type: "FORGE_VETERANCY", mechanic: "tank-reposition" }, implementationStatus: "implemented" },
  ...
  "forge-vet-grunt-tempo": { id: "forge-vet-grunt-tempo", name: "Tempo Field", text: "Each combat round, this unit and one chosen adjacent unit gain +1 Initiative.", effect: { type: "FORGE_VETERANCY", mechanic: "grunt-tempo" }, implementationStatus: "implemented" },
  ...
  "town-titan-storm-cache": { id: "town-titan-storm-cache", name: "Storm Cache", text: "During any attack, roll 2 Attack dice and resolve the higher outcome. If both dice are -1, gain a phantom Chain Lightning card, maximum 1 per combat; phantom cards disappear after combat.", effect: { type: "ATTACK_ROLL_ADVANTAGE" }, implementationStatus: "implemented" },
  ...
  "town-kobold-rune-step": { id: "town-kobold-rune-step", name: "Runic Footfall", text: "Whenever this unit moves, gain 2 Runes.", effect: { type: "TOWN_VETERANCY", mechanic: "kobold-rune-step" }, implementationStatus: "implemented" },
  ...
  "town-naga-pierce": { id: "town-naga-pierce", name: "Coiling Blades", text: "On an Attack die of -1 or 0, attacks and retaliation ignore 1 Defense.", effect: { type: "DEFENSE_REDUCTION_ON_ATTACK_DIE", minRoll: -1, maxRoll: 0, amount: 1, allAttacks: true }, implementationStatus: "implemented" },
  ...
  "factory-grenadier-high-roll": { id: "factory-grenadier-high-roll", name: "Perfect Trajectory", text: "When this unit resolves +1 on its Attack die, it gains an additional +3 Attack for that attack.", effect: { type: "ATTACK_BONUS_ON_ATTACK_DIE", minRoll: 1, maxRoll: 1, amount: 3 }, implementationStatus: "implemented" },
  "factory-engineer-attack-support": { id: "factory-engineer-attack-support", name: "Combat Tuning", text: "When this unit activates, choose one adjacent ally. That ally gains +1 Attack for its next attack.", effect: { type: "TOWN_VETERANCY", mechanic: "engineer-attack-support" }, implementationStatus: "implemented" },
  "factory-armadillo-momentum": { id: "factory-armadillo-momentum", name: "Gathering Momentum", text: "While this unit has a positive Initiative buff, it can move 1 additional space and gains +1 Attack.", effect: { type: "TOWN_VETERANCY", mechanic: "armadillo-momentum" }, implementationStatus: "implemented" },
