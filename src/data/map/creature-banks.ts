...
/**
 * BINH-only per-token placement chance. The official rule places every token;
 * this percentage is read only when `bank-stack-chance-80` is enabled.
 */
export const BINH_STACK_TOKEN_PLACEMENT_PERCENT = 80;
