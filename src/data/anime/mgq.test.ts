...
const EXPECTED_STATS: Record<string, { tier: string; type: string; few: SideSignature; pack: SideSignature }> = {
  "mgq.pochi": { tier: "bronze", type: "ground", few: [2, 0, 2, 6, 2, 0], pack: [2, 0, 3, 8, 2, 0] },
  ...
  "mgq.fleesia": { tier: "bronze", type: "ground", few: [2, 1, 3, 3, 2, 0], pack: [2, 2, 3, 4, 4, 0] },
  ...
  "mgq.shizuku": { tier: "silver", type: "ground", few: [4, 1, 5, 4, 8, 0], pack: [5, 1, 5, 5, 13, 0] },
  ...
  "mgq.aria": { tier: "silver", type: "ground", few: [3, 2, 5, 4, 7, 0], pack: [4, 2, 5, 5, 13, 0] },
