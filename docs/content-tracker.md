...
| Alamar (Warlock, magic, A0 D0 P3 K2) | Dungeon | ✅ | Resurrection I implemented: a reaction in an attack window cancels a killing blow on your unit when the Power paid into the window reaches the unit's grade (1 bronze / 2 silver / 4 gold). IV/VI 🟡. |
