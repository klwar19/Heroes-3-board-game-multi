...
| Rin VI | Instant, any unit | Deal 2 damage. Supports combat reaction windows, including before enemy activation, after movement, and before retaliation. |
...
| Riki VI | Instant, pending attack/spell hit | Choose a threatened friendly unit and another living friendly unit. Prevent its entire remaining hit, then deal half the prevented amount, rounded up, to the second unit. Recipient immunities/reductions still apply. HP/death processing happens after prevention. Protection survives delayed area/chain target choices and belongs to that battle only. |
