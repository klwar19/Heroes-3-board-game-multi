...
- Still inert / out of the decks (no engine effect yet): Teleport, Mirth, Sorrow, Slayer, Dimension Door, Forgetfulness, Inferno, Visions; Tactics, Diplomacy, Pathfinding, Learning (Necromancy, Magic Mirror, Intelligence and Artillery are now implemented and in the decks — Artillery's basic shot and its expert Ballista 3× volley both run; Shield of the Dwarven Lords and Orb of Vulnerability are now implemented — see content-tracker.md)
