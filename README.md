...
- **Astrologers rounds**: every even round draws one of the 26 Astrologers Proclaim cards (19 core + 7 expansion) and the engine enforces it — movement and hand-limit modifiers, next-resource-round income shifts, morale handouts, plagues, first-spell bonuses, die rerolls, neutral-draw swaps, Statistic→Empowered swaps (Dancing Imp / Hero) and hand/discard card removal (Plane Between Planes). The active card sits in the HUD; the deck's past draws are browsable.
