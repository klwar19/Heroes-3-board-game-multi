# FAR economy AI verification — 2026-09-12
...
|---|---|---|---|
| impossible | necropolis | R4, 3 MP | R4 gold mine; R6 settlement |
| impossible | castle | R4, 3 MP | R4 settlement; R5 gold mine |
| impossible | conflux | R4, 3 MP | R4 settlement; R6 valuables mine; R8 settlement |
| hard | necropolis | R3, 2 MP | R3 gold mine; R4 settlement |
| hard | castle | R3, 2 MP | R3 settlement; R5 valuables mine |
| hard | conflux | R4, 3 MP | R4 settlement; R6 valuables mine |
| normal | necropolis | R3, 2 MP | R3 gold mine; R4 settlement |
| normal | castle | R3, 2 MP | R3 settlement; R5 settlement |
| normal | conflux | R3, 3 MP | R3 settlement |
...
Detailed actions, resources, attacks, remaining MP, outcomes, captures, and final map are in the corresponding JSON files. Console reports are in final-*.log and mutation-*.log. Final TypeScript, changed-source ESLint, and git diff whitespace checks passed. Scope is these towns and seeded scenarios, not a broad balance or stress suite.
