#!/usr/bin/env python3
"""
Fetch and crop the printed art for additional heroes from the fan wiki
(en.homm3bg.wiki), reusing the exact asset conventions the repo already follows
for every other hero (see fetch-fortress-art.py):
...
# (slug, faction, type) for each hero that ships in this pass.
HEROES = [
    ("fiona", "inferno", "might"),
    ("mephala", "rampart", "might"),
    ("clancy", "rampart", "might"),
    ("adelaide", "castle", "magic"),
]
