...
NAME_MAP = {
    ...
    # C17SPE is the sandy Quicksand obstacle (appear / idle / disperse) — it was
    # mislabeled "force field" in an earlier pass; the real Force Field is C15SPE3.
    "C15SPE3": {"key": "force-field", "label": "Force Field", "group": "obstacle", "role": "affect"},
    "C17SPE0": {"key": "quicksand-appear", "label": "Quicksand (appearing)", "group": "obstacle", "role": "affect"},
    "C17SPE1": {"key": "quicksand", "label": "Quicksand", "group": "obstacle", "role": "affect"},
    "C17SPE2": {"key": "quicksand-disappear", "label": "Quicksand (dispersing)", "group": "obstacle", "role": "affect"},
...
LOOKS_LIKE = {
    ...
    # C15SPE is the Force Field (blue energy barrier); C15SPE3 is wired as
    # "force-field" above, the rest are alternate barrier graphics, unused.
    "C15SPE0": "Force Field barrier variant (C15SPE)",
    "C15SPE1": "Force Field barrier variant (C15SPE)",
    "C15SPE2": "Force Field barrier variant (C15SPE)",
    "C15SPE4": "Force Field barrier variant (C15SPE)",
    "C15SPE5": "Force Field barrier variant (C15SPE)",
    "C15SPE6": "Force Field barrier variant (C15SPE)",
    "C15SPE7": "Force Field barrier variant (C15SPE)",
    "C15SPE8": "Force Field barrier variant (C15SPE)",
    "C15SPE9": "Force Field barrier variant (C15SPE)",
    "C15SPE10": "Force Field barrier variant (C15SPE)",
    "C15SPE11": "Force Field barrier variant (C15SPE)",
